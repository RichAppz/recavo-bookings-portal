    ...
    <DialogPrimitive.Portal>
      ...
      >
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "pointer-events-auto safe-spacer-bottom px-safe flex max-h-full w-full flex-col overflow-hidden rounded-t-2xl border-t bg-background shadow-xl outline-none",
